...
%neural network without hidden layer is a non-linear transformation of the input data, much in the same way as logistic regression, so whether it should be considered a neural network or not is up for discussion.
